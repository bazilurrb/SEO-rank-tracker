...
// Search Googel for a keyword and extractranking results for a target domain
export async function rankTracker(keyword, targetDomain){
    ...
    try{
        ...
        // 3. Seacrh Loop: Iterate through upto 5 pages of Google Results   
        ...
        // 6. Finalisation: Close browser and extract results
        await browser.close();
        ...
        console.error("Ranl check error:", error.message);
